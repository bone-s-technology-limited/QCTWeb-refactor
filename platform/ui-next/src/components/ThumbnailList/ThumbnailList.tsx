...
const ThumbnailList = ({
  ...
  return (
    <div
      ...
      className={`ohif-scrollbar grid place-items-center overflow-y-hidden bg-[#0a0a24] pt-[4px] pr-[2.5px] pl-[2.5px] ${viewPreset === 'thumbnails' ? 'grid-cols-2 gap-[4px] pb-[12px]' : 'grid-cols-1 gap-[2px]'}`}
    >
      {thumbnails.map(
        ({
