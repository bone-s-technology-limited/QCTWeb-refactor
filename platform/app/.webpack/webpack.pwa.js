  ...
  const mergedConfig = merge(baseConfig, {
    ...
    resolve: {
      modules: [
        ...
        path.resolve(__dirname, 'E:/QCTWeb-refactor/modes/hip-bmd-measurement/node_modules'),
        path.resolve(__dirname, 'E:/QCTWeb-refactor/modes/hip-bmd-measurement/node_modules'),
        path.resolve(
          __dirname,
          'E:/QCTWeb-refactor/modes/Inbody-Composition-Analysis/node_modules'
        ),
        path.resolve(__dirname, 'E:/QCTWeb-refactor/extensions/auto-annotation/node_modules'),
        path.resolve(__dirname, 'E:/QCTWeb-refactor/extensions/auto-annotation/node_modules'),
      ],
    },
    plugins: [
